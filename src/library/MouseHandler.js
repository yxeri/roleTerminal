...
class MouseHandler {
  ...
  addGMapsClickListener({
    ...
    if (right) {
      window.google.maps.event.addListener(element, 'rightclick', (event) => {
        this.longClick = false;

        right(event);
      });

      window.google.maps.event.addListener(element, 'mousedown', (event) => {
        this.longClick = true;
      ...
      window.google.maps.event.addListener(element, 'mouseup', () => {
        this.longClick = false;
      });

      window.google.maps.event.addListener(element, 'drag', () => {
        this.longClick = false;
      });
    }
  }
