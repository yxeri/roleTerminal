...
class MapCircle extends MapObject {
  constructor({
    ...
    super({
      ...
      mapObject: new window.google.maps.Circle({
        radius,
        zIndex,
        center: new window.google.maps.LatLng(latestCoordinates.latitude, latestCoordinates.longitude),
  ...
  setCurrentCoordinates({ coordinates }) {
    ...
    this.mapObject.setCenter(new window.google.maps.LatLng(coordinates.latitude, coordinates.longitude));
  }
}
