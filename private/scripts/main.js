...
boot.setQueue([
  {
    ...
    params: {
      ...
      array: [
        'Connected!',
        'Welcome to RAWcom!',
        'AAAAB3NzasasdaC1yc2EAAAADA/QABAAAcbxxcbCAQD5ZM',
        'MKDrZS6d/eLrkX5T9vN7HpB7WiSR/z8CN6DZTWK5s/kRDa',
        'OqRSFAqtI3uIDBs60q8MAvsEK+Z5wKIpOWcSWmy9sZ7FYq',
        '8/NrRs+o52BgjKg5iB1OAWPnQQqef9tmN8e0qTk5xJH/Sf',
        'YbIiF/CvYnAxr3PBLcwU5TLqs4S8LrmV+12E7yTk/nUOI2',
        'FLHa1kqGsNkhABFQIzNV8VLUDEhqsXI/yPng3puEdWYJyq',
        'ETimlSV60onkhhvDvDj9nPIMthtrhV/7iAMFMnf0iIcbKg',
        'FJQEbrbXo9yx5B8uxY1H36CKHZcKRlh5kGEemtv7m/kes7',
        'sqLqkT3ln2wPtrlKrKgiaJZJFW624/8OBepYTcjiNSHB5w',
        'wbgWSG5GBPWZGSN+4c707vQ+fPQwyV/V4Qq4g34235fc/a',
        'QxOVnBE5r/7xK527pFQKl69aeCjsr+ZwTKraDERmUxqMvt',
    ...
    params: {
      ...
      array: [
        'Uplink established!',
        'Downloading modules...',
        'Direct coms retrieved.',
        'Anon coms retrieved',
        'Bcast retrieved.',
        'Checking device against registry...',
      ],
    },
  }, {
    func: boot.printLines,
    params: {
      ...
      corruption: false,
      array: [
        'RAW approved device detected!',
        'wbgWSG5GBPWZGSN+4c707vQ+fPQwyV/V4Qq4g34235fc/a',
        'gr21r56En7esf0gL2YfoughtxUaa4VYJ70032u8P3qMRAt',
        '1mLDaqPdo5sKW0iLD8/Nnj3211O2/g9KE/g+26oUyb6w0G',
        'tMm6597sRYFoZH88LR0pz8X5o48ruy76211ELa/Dps/fOv',
        '6dGFtdHy0nShhtr11/laMJ4JPlNDRxnj5Pcw4aFTxDp1Yo',
        'wusZg+8gOq/g3+3421aXkEl/k8+zPaBinLlM4cNLe+vSt6',
        'S/SpM1TbuFCPN2bXLzEBA8KhrtzaaaYMVcjd9X/JSKwVAX',
        'aSfc1OVdEwcK0o6+TYwfB4247UferFw1W/bm1ibYqvzw8B',
        'W3bxv9TvSS6DMv4I24y/+NVlmb+a7OzmY+6nQZGC8d34jS',
        'Rewriting firmware...',
        'Overriding lock...',
      ],
    },
