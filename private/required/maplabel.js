...
*/
MapLabel=function(a){if(!MapLabel.prototype.setValues)for(var b in google.maps.OverlayView.prototype)MapLabel.prototype.hasOwnProperty(b)||(MapLabel.prototype[b]=google.maps.OverlayView.prototype[b]);this.set("align","center");this.set("fontColor","#00ffcc");this.set("fontFamily","monospace");this.set("fontSize",12);this.set("strokeColor","#001e15");this.set("strokeWeight",4);this.set("zIndex",1E3);this.setValues(a)};window.MapLabel=MapLabel;
