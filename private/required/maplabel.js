...
MapLabel.prototype.draw=function(){var a=this.getProjection();if(a&&this.a){var b=this.get("position");if(b){b=a.fromLatLngToDivPixel(b);a=this.a.style;a.top=b.y+"px";switch(this.get("align")){case "left":a.left=b.x-this.a.width/(window.devicePixelRatio?window.devicePixelRatio:1)+"px";a["margin-left"]="-0.6em";a["margin-top"]="-0.9em";break;case "right":a.left=b.x+"px";a["margin-left"]="0.6em";a["margin-top"]="-0.9em";break;default:a.left=b.x-this.a.width/(window.devicePixelRatio?window.devicePixelRatio:
