...
class Forum extends View {
  constructor() {
    ...
    textContainer.appendChild(elementCreator.createContainer({ classes: ['leftCorner'] }));
    textContainer.appendChild(elementCreator.createContainer({ classes: ['rightCorner'] }));
    textContainer.appendChild(elementCreator.createContainer({ classes: ['upperRightCorner'] }));
